...
/**
 * Auto-Generated class for join point ASparseSwitch
 * This class is overwritten by the Weaver Generator.
 * 
 * Sparse switch directive
 * @author Lara Weaver Generator
 */
public abstract class ASparseSwitch extends AInstruction {
     ...
     * 
     */
    public ASparseSwitch(AInstruction aInstruction){
        super(aInstruction);
    ...
    protected enum SparseSwitchAttributes {
         ...
         * 
         */
        private SparseSwitchAttributes(String name){
            this.name = name;
        }
        /**
         * Return an attribute enumeration item from a given attribute name
         */
        public static Optional<SparseSwitchAttributes> fromString(String name) {
        ...
        public static List<String> getNames() {
            return Arrays.asList(values()).stream().map(SparseSwitchAttributes::name).collect(Collectors.toList());
        }
