...
/**
 * Auto-Generated class for join point APrimitiveLiteral
 * This class is overwritten by the Weaver Generator.
 * 
 * Primitive literal
 * @author Lara Weaver Generator
 */
public abstract class APrimitiveLiteral extends ALiteral {
     ...
     * 
     */
    public APrimitiveLiteral(ALiteral aLiteral){
        super(aLiteral);
     ...
     * @return 
     */
    public abstract String setValueImpl(String value);
     ...
     * @return 
     */
    public final Object setValue(String value) {
        try {
        	if(hasListeners()) {
        		eventTrigger().triggerAttribute(Stage.BEGIN, this, "setValue", Optional.empty(), value);
        	}
        	String result = this.setValueImpl(value);
        	if(hasListeners()) {
        		eventTrigger().triggerAttribute(Stage.END, this, "setValue", Optional.ofNullable(result), value);
        	}
     ...
     * 
     */
    protected enum PrimitiveLiteralAttributes {
        SETVALUE("setValue"),
        PARENT("parent"),
         ...
         * 
         */
        private PrimitiveLiteralAttributes(String name){
            this.name = name;
        }
        /**
         * Return an attribute enumeration item from a given attribute name
         */
        public static Optional<PrimitiveLiteralAttributes> fromString(String name) {
        ...
        public static List<String> getNames() {
            return Arrays.asList(values()).stream().map(PrimitiveLiteralAttributes::name).collect(Collectors.toList());
        }
