...
/**
 * Auto-Generated class for join point AThrowStatement
 * This class is overwritten by the Weaver Generator.
 * 
 * Smali instruction format 11x
 * @author Lara Weaver Generator
 */
public abstract class AThrowStatement extends AInstruction {
     ...
     * 
     */
    public AThrowStatement(AInstruction aInstruction){
        super(aInstruction);
    ...
    protected enum ThrowStatementAttributes {
         ...
         * 
         */
        private ThrowStatementAttributes(String name){
            this.name = name;
        }
        /**
         * Return an attribute enumeration item from a given attribute name
         */
        public static Optional<ThrowStatementAttributes> fromString(String name) {
        ...
        public static List<String> getNames() {
            return Arrays.asList(values()).stream().map(ThrowStatementAttributes::name).collect(Collectors.toList());
        }
