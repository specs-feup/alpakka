...
/**
 * Auto-Generated class for join point ARegisterRange
 * This class is overwritten by the Weaver Generator.
 * 
 * Register range
 * @author Lara Weaver Generator
 */
public abstract class ARegisterRange extends AExpression {
     ...
     * 
     */
    public ARegisterRange(AExpression aExpression){
     ...
     * 
     */
    protected enum RegisterRangeAttributes {
        PARENT("parent"),
         ...
         * 
         */
        private RegisterRangeAttributes(String name){
            this.name = name;
        }
        /**
         * Return an attribute enumeration item from a given attribute name
         */
        public static Optional<RegisterRangeAttributes> fromString(String name) {
        ...
        public static List<String> getNames() {
            return Arrays.asList(values()).stream().map(RegisterRangeAttributes::name).collect(Collectors.toList());
        }
