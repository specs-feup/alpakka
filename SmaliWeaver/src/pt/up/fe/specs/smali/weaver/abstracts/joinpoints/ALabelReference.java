...
/**
 * Auto-Generated class for join point ALabelReference
 * This class is overwritten by the Weaver Generator.
 * 
 * Label reference
 * @author Lara Weaver Generator
 */
public abstract class ALabelReference extends AExpression {
    ...
    protected enum LabelReferenceAttributes {
         ...
         * 
         */
        private LabelReferenceAttributes(String name){
            this.name = name;
        }
        /**
         * Return an attribute enumeration item from a given attribute name
         */
        public static Optional<LabelReferenceAttributes> fromString(String name) {
        ...
        public static List<String> getNames() {
            return Arrays.asList(values()).stream().map(LabelReferenceAttributes::name).collect(Collectors.toList());
        }
