package pt.up.fe.specs.smali.weaver.abstracts.weaver;
 ...
 * The abstract class {@link pt.up.fe.specs.smali.weaver.abstracts.ASmaliWeaverJoinPoint} can be used to add user-defined methods and fields which the user intends to add for all join points and are not intended to be used in LARA aspects.
 * The implementation of the abstract methods is mandatory!
 * @author Lara C.
 */
public abstract class ASmaliWeaver extends LaraWeaverEngine {
