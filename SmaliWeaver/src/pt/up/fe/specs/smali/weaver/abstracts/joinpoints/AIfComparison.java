 ...
 */
public abstract class AIfComparison extends AInstruction {
     ...
     * 
     */
    public AIfComparison(AInstruction aInstruction){
        super(aInstruction);
    ...
    protected enum IfComparisonAttributes {
         ...
         * 
         */
        private IfComparisonAttributes(String name){
            this.name = name;
        }
        /**
         * Return an attribute enumeration item from a given attribute name
         */
        public static Optional<IfComparisonAttributes> fromString(String name) {
        ...
        public static List<String> getNames() {
            return Arrays.asList(values()).stream().map(IfComparisonAttributes::name).collect(Collectors.toList());
        }
