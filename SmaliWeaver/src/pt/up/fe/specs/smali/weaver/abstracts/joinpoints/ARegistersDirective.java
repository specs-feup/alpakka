...
/**
 * Auto-Generated class for join point ARegistersDirective
 * This class is overwritten by the Weaver Generator.
 * 
 * Registers directive
 * @author Lara Weaver Generator
 */
public abstract class ARegistersDirective extends AStatement {
     ...
     * 
     */
    public ARegistersDirective(AStatement aStatement){
     ...
     * @return the attribute's value
     */
    public abstract APrimitiveLiteral getValueImpl();
    ...
    public final Object getValue() {
        try {
        	...
        	APrimitiveLiteral result = this.getValueImpl();
        	if(hasListeners()) {
     ...
     * 
     */
    public void defValueImpl(APrimitiveLiteral value) {
        throw new UnsupportedOperationException("Join point "+get_class()+": Action def value with type APrimitiveLiteral not implemented ");
    }
    ...
    public final void defImpl(String attribute, Object value) {
        switch(attribute){
        case "value": {
        	if(value instanceof APrimitiveLiteral){
        		this.defValueImpl((APrimitiveLiteral)value);
        		return;
        	}
     ...
     * 
     */
    protected enum RegistersDirectiveAttributes {
        TYPE("type"),
        VALUE("value"),
         ...
         * 
         */
        private RegistersDirectiveAttributes(String name){
            this.name = name;
        }
        /**
         * Return an attribute enumeration item from a given attribute name
         */
        public static Optional<RegistersDirectiveAttributes> fromString(String name) {
        ...
        public static List<String> getNames() {
            return Arrays.asList(values()).stream().map(RegistersDirectiveAttributes::name).collect(Collectors.toList());
        }
