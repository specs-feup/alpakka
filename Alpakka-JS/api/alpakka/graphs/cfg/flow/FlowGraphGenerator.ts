import * as FlowGraph from "./FlowGraph.ts";
import {
  MethodNode,
  Joinpoint,
  Program,
...
import * as UnknownInstructionNode from "./node/instruction/UnknownInstructionNode.ts";
import * as FlowNode from "./node/FlowNode.ts";
import * as InstructionNode from "./node/instruction/InstructionNode.ts";
import type { NodeBuilder } from "../graph/Node.ts";
import * as StatementNode from "./node/instruction/StatementNode.ts";
...
import * as ReturnNode from "./node/instruction/ReturnNode.ts";
import * as LabelNode from "./node/instruction/LabelNode.ts";
import * as GotoNode from "./node/instruction/GotoNode.ts";
import * as SwitchNode from "./node/instruction/SwitchNode.ts";
import * as ThrowNode from "./node/instruction/ThrowNode.ts";
