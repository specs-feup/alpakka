...
/**
 * Auto-Generated class for join point AFieldReference
 * This class is overwritten by the Weaver Generator.
 * 
 * Field reference
 * @author Lara Weaver Generator
 */
public abstract class AFieldReference extends AExpression {
     ...
     * 
     */
    public AFieldReference(AExpression aExpression){
     ...
     * 
     */
    protected enum FieldReferenceAttributes {
        PARENT("parent"),
         ...
         * 
         */
        private FieldReferenceAttributes(String name){
            this.name = name;
        }
        /**
         * Return an attribute enumeration item from a given attribute name
         */
        public static Optional<FieldReferenceAttributes> fromString(String name) {
        ...
        public static List<String> getNames() {
            return Arrays.asList(values()).stream().map(FieldReferenceAttributes::name).collect(Collectors.toList());
        }
