...
/**
 * Auto-Generated class for join point AIfComparisonWithZero
 * This class is overwritten by the Weaver Generator.
 * 
 * Smali instruction format 21t
 * @author Lara Weaver Generator
 */
public abstract class AIfComparisonWithZero extends AInstruction {
     ...
     * 
     */
    public AIfComparisonWithZero(AInstruction aInstruction){
        super(aInstruction);
    ...
    protected enum IfComparisonWithZeroAttributes {
         ...
         * 
         */
        private IfComparisonWithZeroAttributes(String name){
            this.name = name;
        }
        /**
         * Return an attribute enumeration item from a given attribute name
         */
        public static Optional<IfComparisonWithZeroAttributes> fromString(String name) {
        ...
        public static List<String> getNames() {
            return Arrays.asList(values()).stream().map(IfComparisonWithZeroAttributes::name).collect(Collectors.toList());
        }
