...
/**
 * Auto-Generated class for join point ARegisterReference
...
public abstract class ARegisterReference extends AExpression {
     ...
     * 
     */
    protected enum RegisterReferenceAttributes {
        PARENT("parent"),
         ...
         * 
         */
        private RegisterReferenceAttributes(String name){
            this.name = name;
        }
        /**
         * Return an attribute enumeration item from a given attribute name
         */
        public static Optional<RegisterReferenceAttributes> fromString(String name) {
        ...
        public static List<String> getNames() {
            return Arrays.asList(values()).stream().map(RegisterReferenceAttributes::name).collect(Collectors.toList());
        }
