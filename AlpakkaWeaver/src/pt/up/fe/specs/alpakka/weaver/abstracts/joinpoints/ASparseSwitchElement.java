...
/**
 * Auto-Generated class for join point ASparseSwitchElement
 * This class is overwritten by the Weaver Generator.
 * 
 * Sparse switch element
 * @author Lara Weaver Generator
 */
public abstract class ASparseSwitchElement extends AExpression {
     ...
     * 
     */
    public ASparseSwitchElement(AExpression aExpression){
     ...
     * 
     */
    protected enum SparseSwitchElementAttributes {
        LABEL("label"),
        AST("ast"),
        CHILDREN("children"),
        CODE("code"),
         ...
         * 
         */
        private SparseSwitchElementAttributes(String name){
            this.name = name;
        }
        /**
         * Return an attribute enumeration item from a given attribute name
         */
        public static Optional<SparseSwitchElementAttributes> fromString(String name) {
        ...
        public static List<String> getNames() {
            return Arrays.asList(values()).stream().map(SparseSwitchElementAttributes::name).collect(Collectors.toList());
        }
